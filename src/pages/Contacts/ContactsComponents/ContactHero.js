      ...
      <div className="hero-content">
        <div className="hero-text-container">
          <h1 className="hero-title">
            Get In
            <span className="hero-highlight"> Touch</span>
          </h1>
          <p className="hero-subtitle">
            Ready to protect your property from pests? Our expert team is here to help. 
            Contact us for free inspections, emergency services, or general inquiries.
          </p>
          <div className="hero-stats">
            ...
            <div className="hero-stat">
              ...
              <div className="hero-stat-label">Inspections</div>
            </div>
          </div>
        </div>
        <div className="hero-image-container">
          <img 
            ...
            alt="Contact Pest Control Experts"
